        ...
        <a-row class="form-row" :gutter="0">
          ...
          <a-col :lg="8">
            <a-form-item
              ...
              <j-dict-select-tag v-model="formData.packageId" placeholder="请选择套餐" dictCode="iot_standard_cost,package_name,id,statue = '0' and operator_type='1'"/>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      queryDiscountPackage(){
        ...
        var that = this;
        queryDiscountPackage({operatorType:"1"}).then((res)=>{
          if(res.success){
          that.packageData = [];
          let treeList = res.result
          for(let a=0;a<treeList.length;a++){
