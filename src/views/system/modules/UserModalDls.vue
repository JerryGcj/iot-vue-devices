    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" v-if="!model.id">
        ...
        <a-form-item label="联系人" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-input placeholder="请输入联系人" v-decorator="[ 'realname', validatorRules.userCompany]" />
        </a-form-item>
        ...
        <a-form-item label="分佣金额" :labelCol="labelCol" :wrapperCol="wrapperCol" >
      ...
      <a-form :form="form" v-if="model.id">
        ...
        <a-form-item label="分佣金额" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-input placeholder="请输入分佣金额" v-decorator="[ 'profitShare', {}]" />
        </a-form-item>
        <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea placeholder="请输入备注"  v-decorator="[ 'note', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'username','sex','realname','email','phone','activitiSync','workNo','telephone','post','status','subordinatePartnerId','storeAddress','profitShare','userCompany','note'))
        });
        // 调用查询用户对应的部门信息的方法
      ...
      handleSubmit () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if(!this.model.id){
              formData.userType = '2';
              formData.selectedroles = '1410494650172211201';
