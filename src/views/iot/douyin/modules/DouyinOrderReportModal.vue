        ...
        <div class="salesCard">
          <a-tabs default-active-key="1" size="large" :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
            <a-tab-pane loading="true" table="图表" key="1">
              <div class="table-page-search-wrapper">
                <a-form layout="inline" @keyup.enter.native="searchQuery">
                  <a-row :gutter="24">
                    <a-col :md="10" :sm="14">
                      <a-form-item>
                        <j-date v-model="createTime_begin" date-format="YYYY-MM-DD 00:00:00" class="query-group-cust" placeholder="请选择开始时间" @click="searchQuery"/>
                        <span style="width: 10px;"> ~ </span>
                        <j-date v-model="createTime_end" dete-format="YYYY-MM-DD 00:00:00" class="query-group-cust" placeholder="请选择结束时间" @click="searchQuery"/>
                      </a-form-item>
                    </a-col>
                    <a-col :md="4" :sm="6">
              ...
              <line-chart-multid :fields="['num']" :dataSource="lineData" :aliases="[{field:'num',alias:'订单数量'}]" title="订单数量统计"/>
              <div>
                总订单数量: {{count}}
              </div>
            </a-tab-pane>
  ...
  export default {
    ...
    data () {
      return {
        ...
        count: '',
        url: {
          queryMoneyChartUrl: "/douyin/electronChannelDouyinOrder/queryMoneyData"
        }
      }
    },
    created() {
