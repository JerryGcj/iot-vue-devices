            ...
            <a-col :span="8">
                    <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                      ...
                      <a-popconfirm :title="money" @confirm="() => settlement()">
                        <a-button v-has="'electronShareProfit:settlement'" type="primary" @click="settlement1" icon="money-collect" style="margin-left: 8px">结算</a-button>
                      </a-popconfirm>
...
<script>
  ...
  import ShareProfitsHisModal from "./ShareProfitsHisModal";
  ...
  export default {
    ...
    data() {
      return {
        ...
        loading: false,
        url: {
          list: "/electronshareprofits/electronShareProfits/listDetails",
          edit: "/electronshareprofits/electronShareProfits/edit",
          getNoSettle: "/electronshareprofits/electronShareProfits/getNoSettle",
          refund: "/electronshareprofits/electronShareProfits/refund",
          exportXlsUrl: "/electronshareprofits/electronShareProfits/exportXlsDetails"
        }
      }
    },
    methods: {
      edit(record) {
        this.visible = true;
        this.queryParam.higherAgentId = record.cusId;
        this.queryParam.agentId = record.agentId;
      ...
      settlement1(){
        const that = this;
        var accessNumber = this.queryParam.accessNumber;
        var agentId = this.queryParam.agentId;
        var createTime = this.queryParam.createTime;
        var higherAgentId = this.queryParam.higherAgentId;
        /*if(!accessNumber&&!timeStart&&!timeEnd){
