    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          customPackageUse:{
            rules: [{
              required: true, message: '请输入倍数!'
            }]
          },

        },
        url: {
          setFlowUsage: "/terminalsalesdiscount/terminalSalesDiscount/setFlowUsage"
        },
      }
    },
    created () {
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            var params = {ids: ids,customPackageUse:values.customPackageUse};
            postAction(this.url.setFlowUsage,params).then((res)=>{
              if(res.success){
