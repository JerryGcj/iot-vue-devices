          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="销售产品">
              <j-multi-select-tag
                ...
                dictCode="electron_channel_agent,agent_name,id,agent_simple_name like 'guangdian'"
                placeholder="请选择销售产品">
              </j-multi-select-tag>
            </a-form-item>
          </a-col>
...
<!--              </a-select>-->
    ...
    <div class="table-operator">
      ...
      <a-button  v-has="'electronChannelWaistOrderList:cancelOrder'" @click="cancelOrder" type="primary" icon="plus">取消订单</a-button>
    ...
    <gd-manual-submit-order-modal ref="gdManualSubmitModal" @ok="modalFormOk"></gd-manual-submit-order-modal>
...
<script>
  ...
  import GdManualSubmitOrderModal from "./modules/GdManualSubmitOrderModal";
  import CancelOrderModal from "./modules/cancelOrderModal";


  export default {
    name: "ElectronOrderHnTelecom00List",
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/gdList?simpleName="+'guangdian',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportGdXls?simpleName=" + 'guangdian',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("guangdian");
        this.$refs.report2Modal.title = "报表";
        this.$refs.report2Modal.disableSubmit = false;
      },
      //手动提单
      manualSubmit: function () {
        this.$refs.gdManualSubmitModal.add();
        this.$refs.gdManualSubmitModal.title = "手动提单";
        this.$refs.gdManualSubmitModal.disableSubmit = false;
      },
      getImportUrl(){
      ...
      cancelOrder() {
        ...
        this.$refs.cancelOrderModal.title = "取消订单";
