...
<!--              </a-select>&ndash;&gt;-->
<!--&lt;!&ndash;              <j-search-select-tag&ndash;&gt;-->
<!--&lt;!&ndash;                placeholder="请选择代理商"&ndash;&gt;-->
<!--&lt;!&ndash;                v-model="queryParam.cusId"&ndash;&gt;-->
<!--&lt;!&ndash;                dict="sys_user,realname,id"&ndash;&gt;-->
...
<!--          </a-col>-->
          ...
          <a-col :md="4" :sm="6">
            <a-form-item label="身份证号">
              <a-input placeholder="请输入身份证号" v-model="queryParam.cusIdno"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="6">
...
<script>
  ...
  export default {
    name: "ElectronChannelWaistOrderList",
    ...
    data () {
      return {
        ...
        // },
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'jsth',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'jsth',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("jsth");
