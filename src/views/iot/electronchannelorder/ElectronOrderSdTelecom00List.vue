  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'jsth-telecom',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'jsth-telecom',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("jsth-telecom");
