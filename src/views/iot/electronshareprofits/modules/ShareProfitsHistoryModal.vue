...
<script>
  ...
  import IotWithdrawDepositModal from "../../withdrawdeposit/modules/IotWithdrawDepositModal";
  import modalAuditForm from "../../withdrawdeposit/modules/IotWithdrawDepositAuditModal";
    ...
    data() {
      return {
        ...
        url: {
          ...
          edit: "/electronshareprofits/electronShareProfits/adminEdit"
        }
      }
    },
    methods: {
