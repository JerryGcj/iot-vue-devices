...
//根据id获取标准资费列表
const queryStandardcostById = (params)=>getAction("/standardcost/standardCost/queryStandardcostById",params);

//获取下级代理列表
const queryLowerAgent = (params)=>getAction("/sys/user/queryLowerAgent",params);

const queryAgents = (params)=>getAction("/sys/user/queryAgent",params);

//根据运营商获取折扣套餐
const queryStandardcostByOperator = (params)=>getAction("/standardcost/standardCost/queryStandardCostByOperator",params);
...
//获取标准资费列表
const queryDiscountPackage = (params)=>getAction("/standardcost/standardCost/queryDiscountPackage",params);
//获取联通标准资费列表
const queryUnicomPackage = (params)=>getAction("/discountpackage/discountPackage/queryUnicomPackage",params);

//获取电信标准资费列表
const queryTelecomPackage = (params)=>getAction("/discountpackage/discountPackage/queryTelecomPackage",params);
...
const telecomCardDataUpdate= (params)=>getAction("/telecomcardinformation/telecomCardInformation/cardDataUpdate",params);
//根据条件配置的套餐
...
const getTelecomRefCardCostByCardId= (params)=>getAction("/telecomrefcardcost/telecomRefCardCost/getRefCardCostByCardId",params);
export {
  // imgView,
  // doMian,
  addRole,
