  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="下单人微信openId" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'openId', validatorRules.openId]" placeholder="请输入下单人微信openId"></a-input>
        </a-form-item>
        ...
        <a-form-item label="头像url" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'headImgurl', validatorRules.headImgurl]" placeholder="请输入头像url"></a-input>
        </a-form-item>
        ...
        <a-form-item label="用户特权信息" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'privilege', validatorRules.privilege]" placeholder="请输入用户特权信息"></a-input>
        </a-form-item>
        <a-form-item label="用户将公众号绑定到微信开放平台帐号标识" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'unionid', validatorRules.unionid]" placeholder="请输入用户将公众号绑定到微信开放平台帐号标识"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/gzhuser/gzhUser/add",
          edit: "/gzhuser/gzhUser/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'openId','nickName','sex','province','city','country','headImgurl','appId','privilege','unionid','createBy','createTime','updateBy','updateTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'openId','nickName','sex','province','city','country','headImgurl','appId','privilege','unionid','createBy','createTime','updateBy','updateTime'))
      },
