...
export const constantRouterMap = [
  ...
  /*{
    path: '/flowpooldetails/flowPoolDetails',
    component: TabLayout,
    children: [
      {
        path: 'list',
        name: 'FlowPoolDetailsList',
        component: () => import('@/views/iot/flowpooldetails/FlowPoolDetailsList'),
        meta: {title: '系统流量池详情'},
      }
    ]
  },
  {
    path: '/cardinformation/cardInformation',
    component: TabLayout,
    children: [
      {
        path: 'list',
        name: 'CardInformationList',
        component: () => import('@/views/iot/card/CardInformationList'),
        meta: {title: '物联网卡信息'}
      }
    ]
  },
    ...
    children: [
      {
        path: '',
        name: 'IotTaskModal',
        component: () => import('@/views/iot/task/IotTaskAdd'),
        meta: {title: '预警任务添加'}
      }
    ]
  }*/
