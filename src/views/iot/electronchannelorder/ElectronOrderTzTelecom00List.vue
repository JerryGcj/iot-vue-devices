...
<!--          </a-col>-->
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="销售产品">
              <j-multi-select-tag
                ...
                dictCode="electron_channel_agent,agent_name,id,agent_simple_name like 'zjtz-telecom'"
                placeholder="请选择销售产品">
              </j-multi-select-tag>
            </a-form-item>
          </a-col>
          ...
          <!--<a-col :md="5" :sm="6">
            <a-form-item label="通道名称">
              <j-dict-select-tag v-model="queryParam.agentId" placeholder="请选择通道" dictCode="electron_channel_agent,agent_name,id"/>
            </a-form-item>
          </a-col>-->
    ...
    <div class="table-operator">
      ...
      <!--</a-upload>-->
      <!--&lt;!&ndash;<a-button type="primary" icon="set" @click="autoDelivery()">自动提单</a-button>&ndash;&gt;-->
      ...
      <!--&lt;!&ndash;<a-button  @click="handleAdd" type="primary" icon="plus">新增线下发货订单</a-button>&ndash;&gt;-->
...
<script>
  ...
  export default {
    name: "ElectronOrderTzTelecom00List",
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'zjtz-telecom',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'zjtz-telecom',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("zjtz-telecom");
      ...
      showDetails:function(id){
        getAction('electronregular/electronChannelOrderRegular/queryByExpressNo?expressNo='+id,null).then((res) => {
          console.log(res)
          if (res.success) {
