<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a v-has="'iotOperatorList:edit'"  v-if="record.operatorTypeId == 1" @click="groupManager(record)">群组管理</a>
          <a-divider type="vertical" />
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
                ...
                <!--<a-menu-item>-->
                  <!--&lt;!&ndash;<a v-has="'iotOperatorList:handleTest'" @click="handleTest(record.id)">接口流控设置</a>&ndash;&gt;-->
                  <!--&lt;!&ndash;<a v-has="'iotOperatorList:handleTest'" @click="relatedGroup(record.id)">群组维护</a>&ndash;&gt;-->
                <!--</a-menu-item>-->
                <a-menu-item>
    ...
    <!--<iot-enterprise-operator-group-modal ref="EnterpriseOperatorGroupModal"></iot-enterprise-operator-group-modal>-->
    <!-- ceshi -->
