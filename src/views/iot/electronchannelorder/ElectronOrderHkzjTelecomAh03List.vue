...
<script>
  ...
  export default {
    name: "ElectronOrderHkzjTelecomAh03List",
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'hkzj-telecom-ah',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'hkzj-telecom-ah',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("hkzj-telecom-ah");
