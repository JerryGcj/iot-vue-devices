      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24" :wrap = true>
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="销售产品">
              <j-multi-select-tag
                ...
                dictCode="electron_channel_agent,agent_name,id,agent_simple_name like 'hkzj-telecom-gz'"
                placeholder="请选择销售产品">
              </j-multi-select-tag>
            </a-form-item>
          </a-col>
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8" :xxl="8" :xxxl="8">
              <a-form-item label="收单日期">
                <j-date :show-time="true" v-model="queryParam.createTime_begin" date-format="YYYY-MM-DD HH:mm:ss" class="" placeholder="请选择开始时间" ></j-date>
...
<script>
  ...
  export default {
    name: "ElectronOrderGzTelecom03List",
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'hkzj-telecom-gz',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'hkzj-telecom-gz',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("hkzj-telecom-gz");
