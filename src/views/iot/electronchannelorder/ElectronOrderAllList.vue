...
<!--                dictCode="electron_channel_agent,agent_name,id,agent_simple_name like 'jsth-telecom'"-->
<!--                placeholder="请选择销售产品">-->
<!--              </j-multi-select-tag>-->
<!--            </a-form-item>-->
            <a-form-item label="销售产品">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/allAgentList",
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/allAgentExportXls",
          ...
          initOperatorUrl:"/electronchannelagent/electronChannelAgent/initOperatorSimpleName",
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("all");
