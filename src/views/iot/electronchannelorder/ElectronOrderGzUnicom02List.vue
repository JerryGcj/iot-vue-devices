          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="销售产品">
              <j-multi-select-tag
                ...
                dictCode="electron_channel_agent,agent_name,id,agent_simple_name like 'dtl-unicom-waist-39-200-200'"
                placeholder="请选择销售产品">
              </j-multi-select-tag>
            </a-form-item>
          </a-col>
...
<script>
  ...
  export default {
    name: "ElectronOrderGzUnicom02List",
    ...
    data () {
      return {
        ...
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'dtl-unicom-waist-39-200-200',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'dtl-unicom-waist-39-200-200',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("dtl-unicom-waist-39-200-200");
