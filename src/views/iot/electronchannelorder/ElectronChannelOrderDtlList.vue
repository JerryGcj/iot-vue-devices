  ...
  export default {
    ...
    data () {
      return {
        ...
        // },
        url: {
          list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'dtl',
          ...
          exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'dtl',
    ...
    methods: {
      ...
      //查看报表
      seeReport2: function () {
        this.$refs.report2Modal.see("dtl");
