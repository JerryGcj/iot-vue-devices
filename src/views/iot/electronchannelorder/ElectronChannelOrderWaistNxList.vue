...
<script>
    ...
    export default {
        name: "ElectronChannelOrderWaistNxList",
        ...
        data () {
            return {
              ...
              description: '腰部订单',
                ...
                url: {
                    list: "/electronregular/electronChannelOrderRegular/list?simpleName="+'hkzj',
                    ...
                    exportXlsUrl: "/electronregular/electronChannelOrderRegular/exportXls?simpleName=" + 'hkzj',
        ...
        methods: {
          ...
          searchReset() {
            ...
            //查看报表
            seeReport2: function () {
                this.$refs.report2Modal.see("hkzj");
