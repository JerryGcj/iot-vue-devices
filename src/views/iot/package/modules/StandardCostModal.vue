      ...
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-select @change="judgePackage" placeholder="-请选择-" v-decorator="[ 'inclusionType', validatorRules.inclusionType]">
            ...
            <a-select-option value="2">按联通计费</a-select-option>
          </a-select>
        </a-form-item>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否为免费套餐">
          <a-radio-group  buttonStyle="solid" v-model="freeType"  v-decorator="[ 'freeType', validatorRules.freeType]">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="日限额（G）" v-if="freeType=='1'">
          <a-input-number v-decorator="[ 'dailyLimit', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="状态">
          <a-radio-group  buttonStyle="solid"   v-decorator="[ 'statue', validatorRules.statue]">
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          basicPackage:{
            rules: [{
              required: true, message: '请选择是否为基础套餐!'
            }]
          },
          freeType:{
            rules: [{
              required: true, message: '请选择是否为免费套餐!'
            }]
          },
          standardRates:{
            rules: [{
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'packageName','operatorType','packageType','containsFlow','containsVoice','containsSms','inclusionType','periodOfValidity','basicPackage','standardRates','statue','effectType','freeType','dailyLimit','createUser','createIp','updateUser','updateIp'))
        //时间格式化
      });
