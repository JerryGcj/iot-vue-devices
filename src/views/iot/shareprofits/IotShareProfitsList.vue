        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8" >
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" icon="download" @click="handleExportXls('返佣明细')" style="margin-left: 8px">导出</a-button>
              <a-button type="primary" v-has="'IotShareProfitsList:shareCount'" icon="money-collect" @click="shareTotal" style="margin-left: 8px">佣金结算</a-button>
...
<script>
  ...
  import {queryAgents} from '@/api/api'
  ...
  export default {
    ...
    methods: {
      ...
      handleDetails(record){
        this.$refs.selectUserModal.edit(record,this.queryParam.createTime);
